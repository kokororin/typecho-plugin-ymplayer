...
Ymplayer.Play = function(obj){
    ...
    if(audioElement.paused != false){
        ...
        if(par.getAttribute("init") == "no"){
            setInterval("Ymplayer.Change("+obj+")",1000);
...
Ymplayer.Skip = function(obj,event){
...
Ymplayer.ChangeVol = function(obj , event){
    obj = audioElement = typeof(obj) == "object" ? obj : document.getElementById(obj);
...
Ymplayer.Move = function(a,event){
            ...
            if(time > lrcEle[parseInt(currentLrc)+1].getAttribute("timeline")){
                ...
                for (var i = 0 in lrcEle) {
                    if (time > lrcEle[currentLrc].getAttribute("timeline")) {
                        ...
                        marginHeight = lrcEle[than - 1].offsetTop - lrcEle[currentLrc].offsetTop;
...
//LRC Parser
Ymplayer.lrcParse = function(obj,n){
    obj = typeof obj == "object" ? obj : document.getElementById(obj);
    par = obj.parentNode;
...
//Change Audio
Ymplayer.changeAudio = function(obj,event){
    obj = typeof obj == "object" ? obj : document.getElementById(obj);
    par = obj.parentNode;
